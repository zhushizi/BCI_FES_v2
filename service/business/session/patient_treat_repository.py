        ...
        try:
            sql = f"""
                INSERT INTO {self.TABLE_NAME} (
                    ...
                    StimIntensity, StimWaveform, StimPulseWidth, StimSide,
                ...
                ON CONFLICT(SessionId) DO UPDATE SET
                    ...
                    StimIntensity = CASE WHEN excluded.StimIntensity != '' THEN excluded.StimIntensity ELSE StimIntensity END,
                    StimWaveform = CASE WHEN excluded.StimWaveform != '' THEN excluded.StimWaveform ELSE StimWaveform END,
                    StimPulseWidth = CASE WHEN excluded.StimPulseWidth != '' THEN excluded.StimPulseWidth ELSE StimPulseWidth END,
                    StimSide = CASE WHEN excluded.StimSide != '' THEN excluded.StimSide ELSE StimSide END,
